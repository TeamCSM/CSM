...
@Controller
@RequestMapping("/customer/sNotice/*")
public class NoticeSearchController {

	private static final Logger logger = LoggerFactory.getLogger(NoticeSearchController.class);
	...
	public String registPOST(NoticeVO board, RedirectAttributes rttr)throws Exception{
		...
		return "redirect:/customer/sNotice/list";
	}
