...
import com.csm.customer.service.QnaBoardService;


@Controller
@RequestMapping("/customer/sQna/*")
public class QnaSearchController {

	private static final Logger logger = LoggerFactory.getLogger(QnaSearchController.class);
