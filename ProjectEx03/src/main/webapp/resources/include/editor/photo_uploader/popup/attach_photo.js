    ...
    function html5Upload() {	
    	var tempFile,
    		sUploadURL;
    	/*sUploadURL= '/market/item/multiplePhotoUpload';*/ 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : location.href.replace(/\/[^\/]*$/, '') + '/market/item/photoUpload',	//샘플 URL입니다.
 	        sCallback : location.href.replace(/\/[^\/]*$/, '') + '/resources/include/editor/SmartEditor2Skin.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
