...
<div id="container">
	...
	<h1 id="container_title">IT 리스트</h1>
<script>
...
$().ready(function() {
	...
	for(i ; i<count; i++){
		...
		str += '<img src="/resources/market/img/it_img.jpg" width="230" height="230" alt="상품 B1">';
...
<img src="/resources/market/img/it_img.jpg" width="230" height="230" alt="상품 B1">
</a>
<div class="sct_btn">
...
<img src="/resources/market/img/it_img2.jpg" width="230" height="230" alt="상품 B1">
</a>
<div class="sct_btn">
            <div class="sct_cart_btn">
...
<div class="sct_btn">
            <div class="sct_cart_btn">
                <button type="button" class="btn_cart" data-it_id="1495680362" value="${baseInfo.item_idx}"><i class="fa fa-shopping-cart" aria-hidden="true"></i></button>
            </div>
        </div>
</div>
