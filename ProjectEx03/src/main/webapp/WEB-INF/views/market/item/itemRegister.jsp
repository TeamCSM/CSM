			...
			<form role="form" method="post" id="registerForm" action="/market/item/itemRegister" enctype="multipart/form-data">
				...
				<div class="box-body">
					<div class="form-group">
						<input type="text" name="item_name" class="form-control" placeholder="제품 이름">
						<div class="text-left">
							<input type="text" name="item_price" class="form-control" placeholder="제품 가격" style="width: 100px; display: inline-block;">
							<input type="number" name="item_sail" class="form-control" min="0" max="100" placeholder="할인률" style="width: 100px; display: inline-block;">
							<input type="text" name="item_amount" class="form-control" placeholder="제품 수량" style="width: 100px; display: inline-block;">
						...
						<input type="text" name="item_title" class="form-control" placeholder="제품 등록글 제목">
					</div>
					<div class="form-group">
