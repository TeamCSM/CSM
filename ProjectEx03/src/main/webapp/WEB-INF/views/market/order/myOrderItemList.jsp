...
<div id="container">
	...
	<h1 id="container_title">주문된 내 상품</h1>
<script>
...
<section id="bo_list" class="container">
    ...
    <div class="tbl_head01 tbl_wrap table-responsive">
        ...
        <tbody id="list">
			<c:forEach items="${orderBaseInfo}" var="myItemInfo">

				<tr>
					<td style="text-align:center; vertical-align: middle;">${myItemInfo.order_idx}</td>
					...
					<td style="text-align:center; vertical-align: middle;">${myItemInfo.order_progress}</td>
					<td style="text-align:center; vertical-align: middle;">
						<c:if test="${!(myItemInfo.order_progress eq '상품배송중')}">
						<a href='/market/order/orderProgressChange?order_idx=${myItemInfo.order_idx}&order_progress=상품배송중'><span class="btn btn-sm btn-success">상품발송</span></a>&nbsp;&nbsp;
						</c:if>
						<a href='#'><span class="btn btn-sm btn-primary">상품캔슬</span></a>
					</td>
				</tr>
