...
<table class="table table-hover">
 ...
 <tbody id="list">
	<c:forEach items="${myMessage}" var="messageVO">
			<tr>
			<td><a href='../message/readPage?messagenum=${messageVO.messagenum }&type=send' class="readMessage">${messageVO.title}</a></td>
