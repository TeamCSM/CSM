...
<link rel="stylesheet" href="/resources/user/css/space.css" />
<link rel="stylesheet" href="/resources/user/js/space.js" />
<!-- /background -->
...
<body style="background-color: white;" id="large-header" class="large-header">

	<div class="container" style="font-size: 15px;">	
		<form id="formObj" action="/user/loginPost" method="post">
		<div class="row text-center">
			<a href="/" style="color: yellowgreen; font-size: 4em; font-weight: bold; text-decoration: none;">
				<img class="" src="/resources/include/img/csm_logo.png" width="200"/></a>
		</div>
		<hr />
		...
		<div>
			<svg class="mySVG" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 200 200">
				...
				<circle cx="100" cy="100" r="100" fill="url('https://www.marcoguglie.it/Codepen/AnimatedHeaderBg/demo-1/img/demo-1-bg.jpg')"/><!-- 설인 배경 -->
				<g class="body">  
			...
			<div class="row">
				...
				<br />
				<div class="input-group input-group-icon" style="margin-left: 30px;">
					<input type="text" placeholder="아이디" id="email" class="email" name="user_id"  />
					<div class="input-icon">
						<i class="fa fa-user"></i>
					</div>
				</div>
				<div class="input-group input-group-icon" style="margin-left: 30px;">
					<input type="password" placeholder="비밀번호" id="password" class="password" name="user_pass" style="width: 196%;"/>
					<div class="input-icon">
						<i class="fa fa-key"></i>
					</div>    
				</div>
    		...
    		<div >
    			<span class="button-effect" style="margin-right: 591px;" >
   						<button type="submit" class="effect effect-3 " id="loginBtn" title="Learn More" style= "margin: auto; text-align: center;  margin-left: 305px; ">Login</button>
 				</span>
 			</div>   
 			...
 			<br />
 			<div class="row">
      			<h4 style="color: white;">- 로그인 상태 유지</h4>
      			<div class="input-group">
			        <input type="checkbox" id="terms" name="useCookie" />
			        <label for="terms" style="margin-left: 30px;"><span style="color:white;">개인정보 보호를 위해, 개인 PC에서만 사용해 주세요.</span></label>
      			</div>
    		</div>
 			<br />
 			<div id="atag" style="margin-left:5px;">
			 <a href="/user/join/signUpTerms" class="text-center" style="color: white; margin-left:10px;">회원가입</a>
 			<span class="txt_bar" style="color: white;">|</span>
			<a href="/user/find/idFind" style="color: white;">아이디</a>
 			<span class="txt_bar" style="color: white;">|</span>
			<a href="/user/find/passFind" style="color: white;">비밀번호 찾기</a><br>
			</div>
 			<br />
 			<br />
		</form>	
...
<script>
  ...
  function testAPI() {
    ...
    FB.api('/me', function(response) {
      ...
      /*   '로그인 중인 아이디 : ' + response.name + '!'; */
      location.href = '/user/loginPostFaceBook?user_id='+response.id+"&user_name="+response.name+"&user_loginType=facebook";
...
<script src="https://apis.google.com/js/platform.js?onload=onLoadCallback" async defer></script>
	...
	<script src="/resources/user/js/index.js"></script>
	  <script src='https://cdnjs.cloudflare.com/ajax/libs/gsap/1.20.3/TweenMax.min.js'></script>
  <script  src="/resources/user/js/animate.js"></script>
