...
<div id="container"><section class="success" id="header">
    <div class="container">
        <div class="intro-text">
            <span class="name wow fadeInDown" data-wow-delay=".5s">상품 리뷰<span class="sound_only"> 목록</span></span>
...
<div class="tbl_head01 tbl_wrap table-responsive">
	...
	<thead class="thead-inverse">
		...
		<c:forEach items="${review }" var="review">
			<tr>
				<td style="text-align:center;">${review.review_title }</td>
				<td style="text-align:center;">${review.review_regdate }</td>
				<td style="text-align:center;">${review.review_score }</td>
			</tr>
		</c:forEach>
	</table>
</div>
