...
<form role="form" method="post">
	...
	<input type='hid den' name='inquiry_bno' value="${list.inquiry_bno}" >
	<%-- 
...
<div class="box-body">
	<div class="form-group">
		<label for="exampleInputEmail1">Title</label> <input type="text"
			name='bestm_title' class="form-control" value="${list.inquiry_title}"
			readonly="readonly">
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		<label for="exampleInputEmail1">Writer</label> <input type="text"
			name="bestm_writer" class="form-control" value="${list.inquiry_writer}"
			readonly="readonly">
	</div>
</div>
<!-- /.box-body -->
...
$(document).ready(function(){
	...
	$(".btn-danger").on("click", function(){
		formObj.attr("action", "/admin/adcustomer/inquiryAnswer");
		formObj.submit();
	});
