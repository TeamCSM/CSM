...
<section id="bo_w" class="container">
    ...
    <!-- 게시물 작성/수정 시작 { -->
    <form id='registerForm' role="form" method="post" id="frm" style="width:100%" action="/admin/adcustomer/noticeregister">
    ...
    <div class="tbl_wrap table-responsive">
        ...
        <tbody>
            ...
            <td><input type="text" name="notice_title" value="" id="wr_name" required class="form-control required" size="10" maxlength="20"></td>
        </tr>
        
                <tr>
            <th scope="row"><label for="wr_password">작성자<strong class="sound_only"> 필수</strong></label></th>
            <td><input type="text" name="notice_writer" value="${login.user_name }" required class="form-control required" maxlength="20" readonly="readonly"></td>
        </tr>          							
        <tr>
            <th scope="row"><label for="wr_content">내용<strong class="sound_only">필수</strong></label></th>
            <td class="wr_content">
            	<textarea class="form-control" name="notice_content" rows="3" id="editor" placeholder="내용을 입력하세요."></textarea>                          
            </td>
