...
<form role="form" method="post">
	<input type="hid den" name="bno" value="${list.bestq_bno }" /> 
</form>
<div class="box-body">
	<div class="form-group">
		<label for="exampleInputEmail1">Title</label> <input type="text"
			name='notice_title' class="form-control" value="${list.bestq_title}"
			readonly="readonly">
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		<label for="exampleInputEmail1">Writer</label> <input type="text"
			name="notice_writer" class="form-control" value="${list.bestq_writer}"
			readonly="readonly">
	</div>
</div>
<!-- /.box-body -->
...
$(document).ready(function(){
	...
	$(".removeBtn").on("click", function(){
		...
		formObj.attr("action", "/admin/adcustomer/bestqremove");
		formObj.submit();
	});
