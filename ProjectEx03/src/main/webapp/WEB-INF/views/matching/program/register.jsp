...
<section id="bo_w" class="container">
    ...
    <div class="tbl_wrap table-responsive">
        ...
        <tbody>
            ...
            <td><input type="text" name="title" value="" id="wr_name" required class="form-control required" size="10" maxlength="20"></td>
        </tr>
        ...
        <tr>
            ...
            <td class="wr_content">
            	<textarea class="form-control" name="contents" rows="3" id="editor" placeholder="내용을 입력하세요."></textarea>                          
            </td>
		<tr>
