...
<section id="bo_w" class="container">
    ...
    <div class="tbl_wrap table-responsive">
        ...
        <tbody>
            ...
            <td><input type="text" name="title" value="${designVO.title }" id="wr_name" required class="form-control required" size="10" maxlength="20"></td>
        </tr>
        ...
        <tr>
            ...
            <td class="wr_content">
            	<textarea class="form-control" id="editor" name="contents" rows="3">${designVO.contents }</textarea>                         
            </td>
		<tr>
