...
<section id="bo_w" class="container">
	...
	<input type="hidden" name="page" value="${pm.perPageNum }" />
    ...
    <div class="tbl_wrap table-responsive">
        ...
        <tr>
            ...
            <td><input type="text" name="writer" value="${boardVO.writer}" readonly="readonly" 
            required class="form-control required" size="10" maxlength="20"></td>
        </tr>
        
        <tr>
            <th scope="row"><label for="wr_homepage">GitHub 주소</label></th>
            <td><input type="text" name="github"  value="${boardVO.github}" class="form-control" size="50"></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <div id="autosave_wrapper">
                    ...
                    value="${boardVO.title}" size="50" maxlength="255">
                                    </div>
            </td>
        </tr>
        <tr>
    ...
    <div class="btn_confirm">
        ...
        <a href="../freeboard/listPage?page=${pm.page }&perPageNum=${pm.perPageNum }" class=" btn btn-primary">취소</a>
    </div>
    </form>
