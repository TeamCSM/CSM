...
<section id="bo_w" class="container">
    ...
    <div class="tbl_wrap table-responsive">
        ...
        <tr>
            <th scope="row">
            <label for="wr_name">질문 종류</label></th><br/>
			<td>
			<select name="question" required class="form-control required">
				<option value="기타">-----------------------</option>
				<option value="디자인">디자인</option>
				<option value="프로그래밍">프로그래밍</option>
				<option value="비용견적">비용견적</option>
        ...
        <tr>
            <th scope="row">
            <label for="wr_name">차감 포인트</label></th><br/>
			<td>
			<select name="point" id="id_point" required class="form-control required">
			...
			$("#id_point").on("change", function(){
				var checkPoint = $(this).val();
				
				$.ajax({
			 		type:'post',
					url : '/community/questionboard/point',
					dataType : 'text',
					data : {user_point:checkPoint},
					success: function(result){
						...
						if(result=='success') {
							...
							alert("포인트부족");
							$('#id_point').val("0").prop("selected",true);
						}
					}
				});
			});
        ...
        <tr>
            ...
            <td><input type="text" name="writer"  value="${login.user_id }" required class="form-control required" size="10" 
