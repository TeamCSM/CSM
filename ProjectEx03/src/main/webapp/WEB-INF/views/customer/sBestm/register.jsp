...
<section id="bo_w" class="container">
    ...
    <div class="tbl_wrap table-responsive">
        ...
        <tbody>
            ...
            <td><input type="text" name="bestm_title" value="" id="wr_name" required class="form-control required" size="10" maxlength="20"></td>
        </tr>
                <tr>
            <th scope="row"><label for="wr_password">작성자<strong class="sound_only"> 필수</strong></label></th>
            <td><input type="text" name="bestm_writer" value="${login.user_id }" required class="form-control required" maxlength="20" readonly="readonly"></td>
        </tr>          
        <tr>
            <th scope="row"><label for="wr_content">내용<strong class="sound_only">필수</strong></label></th>
            <td class="wr_content">
            	<textarea class="form-control" name="bestm_content" rows="3" id="editor" placeholder="내용을 입력하세요."></textarea>                          
            </td>       
        <tr>
