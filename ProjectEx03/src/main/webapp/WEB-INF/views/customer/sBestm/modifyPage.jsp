...
<section id="bo_w" class="container">
	...
	<input type="hidden" name='bestm_bno' class="form-control" value="${bestMVO.bestm_bno}" readonly="readonly">
    <div class="tbl_wrap table-responsive">
        ...
        <tr>
            ...
            <td><input type="text" name="bestm_writer" value="${bestMVO.bestm_writer}" readonly="readonly" 
        ...
        <tr>
            ...
            <td>
                <div id="autosave_wrapper">
                    <input type="text" name="bestm_title"  required class="form-control required" 
                    value="${bestMVO.bestm_title}" size="50" maxlength="255">
        </div>
            </td>
        </tr>
        <tr>
            ...
            <td class="wr_content">
			<textarea name="bestm_content" id="editor" maxlength="65536" style="width:100%;height:300px">
			${bestMVO.bestm_content} </textarea>                          
			</td>
        </tr>
...
$(document).ready(
		...
		$(".btn-warning")
				.on("click",function() {
					self.location = "/customer/sBestm/list?page=${cri.page}&perPageNum=${cri.perPageNum}"
