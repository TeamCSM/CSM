...
<form role="form" method="post">
	...
	<input type='hid den' name='bno' value="${list.qna_bno}" readonly="readonly"/>
...
<article id="bo_v" class="container">
    ...
    <section id="bo_v_info">
        <h2>페이지 정보</h2>
        <strong><span class="sv_guest">제목 : ${list.qna_title}</span></strong><br/>
...
$(document).ready(function(){
	...
	$("#modify").on("click", function(){
		formObj.attr("action", "/customer/sQna/modifyPage");
		formObj.attr("method", "get");		
		formObj.submit();
	});
	
	$("#remove").on("click", function(){
		formObj.attr("action", "/customer/sQna/removePage");
		formObj.submit();
	});
	
	$("#golist").on("click", function(){
		formObj.attr("action", "/customer/sQna/list");
		formObj.attr("method", "get");		
		formObj.submit();
	});
