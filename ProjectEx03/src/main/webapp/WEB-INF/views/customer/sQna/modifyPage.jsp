...
<section id="bo_w" class="container">
	...
	<input type="hidden" name='qna_bno' class="form-control" value="${qnaVO.qna_bno}" readonly="readonly">
    <div class="tbl_wrap table-responsive">
        ...
        <tr>
            ...
            <td><input type="text" name="qna_writer" value="${qnaVO.qna_writer}" readonly="readonly" 
        ...
        <tr>
            ...
            <td>
                <div id="autosave_wrapper">
                    <input type="text" name="qna_title"  required class="form-control required" 
                    value="${qnaVO.qna_title}" size="50" maxlength="255">
        </div>
            </td>
        </tr>
        <tr>
            ...
            <td class="wr_content">
			<textarea name="qna_content" id="editor" maxlength="65536" style="width:100%;height:300px">
			${qnaVO.qna_content} </textarea>                          
			</td>
        </tr>
...
$(document).ready(
		...
		$(".btn-warning")
				.on("click",function() {
					self.location = "/customer/sQna/list?page=${cri.page}&perPageNum=${cri.perPageNum}"
