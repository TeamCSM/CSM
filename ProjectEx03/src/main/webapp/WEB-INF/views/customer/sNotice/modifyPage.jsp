...
<section id="bo_w" class="container">
	...
	<input type="hidden" name='notice_bno' class="form-control" value="${noticeVO.notice_bno}" readonly="readonly">
    <div class="tbl_wrap table-responsive">
        ...
        <tr>
            ...
            <td><input type="text" name="notice_writer" value="${noticeVO.notice_writer}" readonly="readonly" 
        ...
        <tr>
            ...
            <td>
                <div id="autosave_wrapper">
                    <input type="text" name="notice_title"  required class="form-control required" 
                    value="${noticeVO.notice_title}" size="50" maxlength="255">
        </div>
            </td>
        </tr>
        <tr>
            ...
            <td class="wr_content">
			<textarea name="notice_content" id="editor" maxlength="65536" style="width:100%;height:300px">
			${noticeVO.notice_content} </textarea>                          
			</td>
        </tr>
...
$(document).ready(
		...
		$(".btn-warning")
				.on("click",function() {
					self.location = "/customer/sNotice/list?page=${cri.page}&perPageNum=${cri.perPageNum}"
