...
<section class="success" id="header">
    <div class="container">
        <div class="intro-text">
            <span class="name wow fadeInDown" data-wow-delay=".5s">자주찾는질문<span class="sound_only"> 목록</span></span>
...
<article id="bo_v" class="container">
    ...
    <section id="bo_v_info">
        <h2>페이지 정보</h2>
        <strong><span class="sv_guest">제목 : ${list.bestq_title}</span></strong><br/>
