...
<section id="bo_w" class="container">
	...
	<input type="hidden" name='bestq_bno' class="form-control" value="${bestQVO.bestq_bno}" readonly="readonly">
    <div class="tbl_wrap table-responsive">
        ...
        <tr>
            ...
            <td><input type="text" name="bestq_writer" value="${bestQVO.bestq_writer}" readonly="readonly" 
        ...
        <tr>
            ...
            <td>
                <div id="autosave_wrapper">
                    <input type="text" name="bestq_title"  required class="form-control required" 
                    value="${bestQVO.bestq_title}" size="50" maxlength="255">
        </div>
            </td>
        </tr>
        <tr>
            ...
            <td class="wr_content">
			<textarea name="bestq_content" id="editor" maxlength="65536" style="width:100%;height:300px">
			${bestQVO.bestq_content} </textarea>                          
			</td>
        </tr>
